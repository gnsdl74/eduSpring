...
public class ControllerTest {
	...
	@Autowired // 스프링 프레임워크에서 객체를 생성해서 주입(injection)하라고 설정
	private WebApplicationContext wac;
	
	// MVC 패턴의 앱을 테스트하느느 mock-up 객체
	...
	public void test() throws Exception {
		...
		RequestBuilder req = MockMvcRequestBuilders.post("/test3").param("username", "admin").param("age", "123");
		mock.perform(req);
	} // end test()
